	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'luxury-gray-light': 'hsl(var(--luxury-gray-light))',
			...
			keyframes: {
				...
				'glow': {
					'0%': { boxShadow: '0 0 20px hsl(var(--luxury-gold) / 0.3)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--luxury-gold) / 0.6)' },
					'100%': { boxShadow: '0 0 20px hsl(var(--luxury-gold) / 0.3)' }
				}
			},
			animation: {
